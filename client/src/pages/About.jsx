            ...
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 lg:gap-16">
              <div className="flex flex-col gap-6">
                ...
                <p className="text-sm leading-relaxed font-light text-muted max-w-80">
                  ...
                  sentence: what the frame feels like before the story takes
                  over. We are building an archive of images worth sitting with.
                </p>
              </div>
              <div className="relative w-full overflow-hidden aspect-video">
                <img
            ...
            <div className="flex flex-col lg:flex-row lg:items-start gap-12 lg:gap-0">
              ...
              <div className="flex flex-col gap-8 lg:flex-1">
                ...
                <p className="text-sm leading-relaxed font-light max-w-sm text-muted">
                  ...
                  criticism, or distribution and believe in cinema that earns
                  its silence — we would like to hear from you.
                </p>
                <div>
                  <Link
                    to={"/collection"}
