...
function About() {
  return (
    <div className="font-body min-h-screen w-full bg-bg text-foreground">
      {/* ── HERO ── */}
      <section className="max-w-[1280px] mx-auto px-6 md:px-12 py-16 md:py-24 flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10 lg:gap-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 lg:gap-16">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-sm leading-relaxed font-light text-muted max-w-80">
                Solium organises film not by genre or release date but by visual
                mood — the feeling a frame produces before any narrative begins.
                Each mood is a lens: noir, grain, silence, humidity. We focus
                on:
                <br />
                <br />
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-16 md:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 lg:gap-16">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-sm leading-relaxed font-light text-muted max-w-80">
                Our editors are not algorithms. Every film in Solium has been
                placed by hand into a mood it genuinely inhabits. Each entry
                carries a single editorial line — not a synopsis, but a visual
                sentence: what the frame feels like before the story takes over.
                We are building an archive of images worth sitting with.
              </p>
            </div>
            <div className="relative w-full overflow-hidden aspect-video">
              <img
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 lg:gap-16">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-sm leading-relaxed font-light text-muted max-w-80">
                ...
                Mood before genre. You are not searching for a film — you are
                waiting for one to find you. A performance of cinema that
                celebrates the image and the long take.
              </p>
            </div>
            <div className="relative w-full overflow-hidden aspect-video">
              <img
          ...
          <div className="flex flex-col lg:flex-row lg:items-start gap-12 lg:gap-0">
            ...
            <div className="flex flex-col gap-8 lg:flex-1">
              ...
              <p className="text-sm leading-relaxed font-light max-w-sm text-muted">
                Solium is expanding its archive. If you work in film curation,
                criticism, or distribution and believe in cinema that earns its
                silence — we would like to hear from you.
              </p>
              <div>
                <button className="text-xs uppercase tracking-widest px-6 py-3 transition-colors duration-300 border border-border-focus/20 text-foreground bg-transparent hover:bg-foreground hover:text-bg cursor-pointer">
      ...
      <section className="border-b border-border">
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-16 md:py-24 flex flex-col items-center text-center gap-8">
          ...
          <p className="text-sm leading-relaxed font-light max-w-sm md:max-w-md text-muted">
            Occasional writing on the films we collect — cinematography notes,
            director profiles, and the visual logic behind each mood. Stay
            informed about new additions and seasonal selections.
          </p>
          <button className="text-xs uppercase tracking-widest px-6 py-3 transition-colors duration-300 border border-border-focus/20 text-foreground bg-transparent hover:bg-foreground hover:text-bg cursor-pointer">
            Subscribe
          </button>
      ...
      {/* ── FOOTER ── */}
      <footer>
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-16 md:py-20 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 items-start">
          <div>
