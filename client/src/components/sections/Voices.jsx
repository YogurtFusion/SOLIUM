    ...
    <section className="bg-neutral-100 min-h-screen py-20 px-6 md:px-24 selection:bg-black selection:text-white ">
      ...
      <div className=" max-w-5xl mx-auto   ">
        ...
        <header className=" mb-20 border-b border-neutral-300 pb-8  ">
          <h2 className=" text-6xl font-heading font-medium tracking-tight uppercase  text-neutral-950 ">
            Voices
          </h2>
        ...
        <div className="space-y-16">
          {words.map((item) => (
            <figure
              ...
              key={item.id}
            >
              <blockquote className=" text-lg  md:text-5xl  md:tracking-tight font-heading  text-neutral-800 tracking-tight leading-tight max-w-3xl    ">
                {" "}
                {item.des}{" "}
              </blockquote>
              <figcaption className="mt-6 flex items-center gap-4 text-neutral-500 text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold font-heading ">
