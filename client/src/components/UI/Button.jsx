...
const MainButton = ({ px, py, title, hide, other }) => {
  return (
    <button
      className={`${px}  ${py} relative bg-white/5  active:bg-white/10 border border-neutral-500 hover:border-neutral-100 text-white/90 flex justify-between items-center gap-3 text-base group cursor-pointer ${other}`}
    >
